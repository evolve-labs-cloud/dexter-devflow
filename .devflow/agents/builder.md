...
APÓS implementar código:
  → SEMPRE mencione: "@guardian revisar código implementado"
  → SEMPRE mencione: "@chronicler documentar mudanças"

SE encontrar problema no design durante implementação:
  → PARAR implementação
  → SEMPRE mencione: "@architect revisar design - encontrei [problema]"
```
